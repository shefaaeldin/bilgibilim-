            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                            ...
                            <div class="dropdown profile-element"> <span>
                                ...
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">Admin name</strong>
                                        </span> <span class="text-muted text-xs block">Admin role<b class="caret"></b></span> </span> </a>
                        ...
                        <li>
                            <a href="{{route('dashboard_home')}}" ><i class="fa fa-shopping-cart"></i> <span class="nav-label">Home</span></a>
                        </li>
                        <li>
                            <a href="{{route('articles.index')}}" ><i class="fa fa-shopping-cart"></i> <span class="nav-label">Articles</span></a>
                        </li>
                        <li>
